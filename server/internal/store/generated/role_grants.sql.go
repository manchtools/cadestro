...
func (q *Queries) BumpSessionVersionForUserGroupMembers(ctx context.Context, arg BumpSessionVersionForUserGroupMembersParams) (int64, error) {
	result, err := q.db.ExecContext(ctx, bumpSessionVersionForUserGroupMembers, arg.UpdatedAt, arg.GroupID)
	if err != nil {
		return 0, err
	}
...
func (q *Queries) CountEnabledUnscopedAdmins(ctx context.Context) (int64, error) {
	row := q.db.QueryRowContext(ctx, countEnabledUnscopedAdmins)
	var count int64
	err := row.Scan(&count)
	return count, err
}
...
func (q *Queries) DeleteScopedUserGroupRoleGrant(ctx context.Context, arg DeleteScopedUserGroupRoleGrantParams) (UserGroupRole, error) {
	row := q.db.QueryRowContext(ctx, deleteScopedUserGroupRoleGrant,
		arg.GroupID,
		arg.RoleID,
		arg.ScopeKind,
		arg.ScopeID,
...
func (q *Queries) DeleteScopedUserRoleGrant(ctx context.Context, arg DeleteScopedUserRoleGrantParams) (UserRole, error) {
	row := q.db.QueryRowContext(ctx, deleteScopedUserRoleGrant,
		arg.UserID,
		arg.RoleID,
		arg.ScopeKind,
		arg.ScopeID,
...
func (q *Queries) DeleteUnscopedUserGroupRoleGrant(ctx context.Context, arg DeleteUnscopedUserGroupRoleGrantParams) (UserGroupRole, error) {
	row := q.db.QueryRowContext(ctx, deleteUnscopedUserGroupRoleGrant, arg.GroupID, arg.RoleID)
	var i UserGroupRole
	err := row.Scan(
		&i.GrantID,
		&i.GroupID,
...
func (q *Queries) DeleteUserGroupMembershipsForUser(ctx context.Context, userID string) (int64, error) {
	result, err := q.db.ExecContext(ctx, deleteUserGroupMembershipsForUser, userID)
	if err != nil {
		return 0, err
	}
	return result.RowsAffected()
...
func (q *Queries) DeleteUserRoleGrantsForUser(ctx context.Context, userID string) (int64, error) {
	result, err := q.db.ExecContext(ctx, deleteUserRoleGrantsForUser, userID)
	if err != nil {
		return 0, err
	}
	return result.RowsAffected()
...
func (q *Queries) InsertUserGroupRoleGrant(ctx context.Context, arg InsertUserGroupRoleGrantParams) (UserGroupRole, error) {
	row := q.db.QueryRowContext(ctx, insertUserGroupRoleGrant,
		arg.GrantID,
		arg.GroupID,
		arg.RoleID,
		arg.AssignedAt,
...
func (q *Queries) ListUserGroupIDsForUser(ctx context.Context, userID string) ([]string, error) {
	rows, err := q.db.QueryContext(ctx, listUserGroupIDsForUser, userID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) ListUserGroupRoleGrants(ctx context.Context, groupID string) ([]ListUserGroupRoleGrantsRow, error) {
	rows, err := q.db.QueryContext(ctx, listUserGroupRoleGrants, groupID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) ListUserRoleGrants(ctx context.Context, userID string) ([]ListUserRoleGrantsRow, error) {
	rows, err := q.db.QueryContext(ctx, listUserRoleGrants, userID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
