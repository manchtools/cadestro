...
func (q *Queries) AddAuthoringActionSetMember(ctx context.Context, arg AddAuthoringActionSetMemberParams) (ActionSetMember, error) {
	row := q.db.QueryRowContext(ctx, addAuthoringActionSetMember,
		arg.SetID,
		arg.ActionID,
		arg.SortOrder,
		arg.AddedAt,
...
func (q *Queries) AddAuthoringDefinitionMember(ctx context.Context, arg AddAuthoringDefinitionMemberParams) (DefinitionMember, error) {
	row := q.db.QueryRowContext(ctx, addAuthoringDefinitionMember,
		arg.DefinitionID,
		arg.ActionSetID,
		arg.SortOrder,
		arg.AddedAt,
...
WITH assignment_groups(source_type, source_id, group_id) AS (
    ...
    WHERE ag.source_type = 'action_set'
      AND ag.group_id IN (SELECT CAST(value AS TEXT) FROM json_each(?3))
    UNION
    ...
    WHERE ag.group_id IN (SELECT CAST(value AS TEXT) FROM json_each(?3))
)
SELECT COUNT(*)
FROM action_sets s
...
type CountAuthoringActionSetsParams struct {
	UnassignedOnly    interface{} `json:"unassigned_only"`
...
func (q *Queries) CountAuthoringActionSets(ctx context.Context, arg CountAuthoringActionSetsParams) (int64, error) {
	row := q.db.QueryRowContext(ctx, countAuthoringActionSets, arg.UnassignedOnly, arg.ScopeRestricted, arg.ScopeGroupIdsJson)
	var count int64
	err := row.Scan(&count)
	return count, err
}
...
WITH assignment_groups(source_type, source_id, group_id) AS (
    ...
    WHERE ag.source_type = 'action'
      AND ag.group_id IN (SELECT CAST(value AS TEXT) FROM json_each(?4))
    UNION
    SELECT m.action_id
    ...
    WHERE ag.group_id IN (SELECT CAST(value AS TEXT) FROM json_each(?4))
    UNION
    SELECT sm.action_id
...
func (q *Queries) CountAuthoringActions(ctx context.Context, arg CountAuthoringActionsParams) (int64, error) {
	row := q.db.QueryRowContext(ctx, countAuthoringActions,
		arg.TypeFilter,
		arg.UnassignedOnly,
		arg.ScopeRestricted,
  ...
  AND (
      ...
      OR EXISTS (
          ...
          WHERE ag.source_type = 'definition'
            ...
            AND ag.group_id IN (SELECT CAST(value AS TEXT) FROM json_each(?2))
      )
  )
`
...
func (q *Queries) CountAuthoringDefinitions(ctx context.Context, arg CountAuthoringDefinitionsParams) (int64, error) {
	row := q.db.QueryRowContext(ctx, countAuthoringDefinitions, arg.ScopeRestricted, arg.ScopeGroupIdsJson)
	var count int64
	err := row.Scan(&count)
	return count, err
}
...
func (q *Queries) DeleteActionMemberships(ctx context.Context, actionID string) ([]string, error) {
	rows, err := q.db.QueryContext(ctx, deleteActionMemberships, actionID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) DeleteAuthoringActionSetMembers(ctx context.Context, setID string) ([]string, error) {
	rows, err := q.db.QueryContext(ctx, deleteAuthoringActionSetMembers, setID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) DeleteAuthoringDefinitionMembers(ctx context.Context, definitionID string) ([]string, error) {
	rows, err := q.db.QueryContext(ctx, deleteAuthoringDefinitionMembers, definitionID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) DeleteDefinitionMembershipsForActionSet(ctx context.Context, actionSetID string) ([]string, error) {
	rows, err := q.db.QueryContext(ctx, deleteDefinitionMembershipsForActionSet, actionSetID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
SELECT id, name, description, schedule, on_failure, created_at, created_by, updated_at, is_deleted FROM action_sets
WHERE id = ? AND is_deleted = FALSE
`

func (q *Queries) GetManifestActionSet(ctx context.Context, id string) (ActionSet, error) {
	row := q.db.QueryRowContext(ctx, getManifestActionSet, id)
	var i ActionSet
	err := row.Scan(
		&i.ID,
		&i.Name,
...
SELECT id, name, description, member_count, schedule, created_at, created_by, updated_at, is_deleted FROM definitions
WHERE id = ? AND is_deleted = FALSE
`

func (q *Queries) GetManifestDefinition(ctx context.Context, id string) (Definition, error) {
	row := q.db.QueryRowContext(ctx, getManifestDefinition, id)
	var i Definition
	err := row.Scan(
		&i.ID,
		&i.Name,
...
RETURNING id, name, description, action_type, desired_state, params, params_canonical, timeout_seconds, schedule, is_system, created_at, created_by, updated_at, is_deleted
`
...
func (q *Queries) InsertAuthoringAction(ctx context.Context, arg InsertAuthoringActionParams) (Action, error) {
	row := q.db.QueryRowContext(ctx, insertAuthoringAction,
		arg.ID,
		arg.Name,
		arg.Description,
		arg.ActionType,
...
RETURNING id, name, description, schedule, on_failure, created_at, created_by, updated_at, is_deleted
`
...
func (q *Queries) InsertAuthoringActionSet(ctx context.Context, arg InsertAuthoringActionSetParams) (ActionSet, error) {
	row := q.db.QueryRowContext(ctx, insertAuthoringActionSet,
		arg.ID,
		arg.Name,
		arg.Description,
		arg.Schedule,
...
RETURNING id, name, description, member_count, schedule, created_at, created_by, updated_at, is_deleted
`
...
func (q *Queries) InsertAuthoringDefinition(ctx context.Context, arg InsertAuthoringDefinitionParams) (Definition, error) {
	row := q.db.QueryRowContext(ctx, insertAuthoringDefinition,
		arg.ID,
		arg.Name,
		arg.Description,
		arg.Schedule,
...
func (q *Queries) ListActionSetMembers(ctx context.Context, setID string) ([]ListActionSetMembersRow, error) {
	rows, err := q.db.QueryContext(ctx, listActionSetMembers, setID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
WITH assignment_groups(source_type, source_id, group_id) AS (
    ...
    FROM assignment_groups ag
    WHERE ag.source_type = 'action_set'
      AND ag.group_id IN (SELECT CAST(value AS TEXT) FROM json_each(?5))
    UNION
    SELECT m.action_set_id
    FROM definition_members m
    JOIN definitions d ON d.id = m.definition_id AND d.is_deleted = FALSE
    JOIN assignment_groups ag ON ag.source_type = 'definition' AND ag.source_id = d.id
    WHERE ag.group_id IN (SELECT CAST(value AS TEXT) FROM json_each(?5))
)
SELECT s.id, s.name, s.description, s.schedule, s.on_failure, s.created_at, s.created_by, s.updated_at, s.is_deleted,
       (
           SELECT COUNT(*)
           FROM action_set_members m
           JOIN actions a ON a.id = m.action_id AND a.is_deleted = FALSE
...
func (q *Queries) ListAuthoringActionSets(ctx context.Context, arg ListAuthoringActionSetsParams) ([]ListAuthoringActionSetsRow, error) {
	rows, err := q.db.QueryContext(ctx, listAuthoringActionSets,
		arg.AfterID,
		arg.UnassignedOnly,
		arg.ScopeRestricted,
		arg.RowLimit,
...
WITH assignment_groups(source_type, source_id, group_id) AS (
    ...
    FROM assignment_groups ag
    WHERE ag.source_type = 'action'
      AND ag.group_id IN (SELECT CAST(value AS TEXT) FROM json_each(?6))
    UNION
    SELECT m.action_id
    FROM action_set_members m
    JOIN action_sets s ON s.id = m.set_id AND s.is_deleted = FALSE
    JOIN assignment_groups ag ON ag.source_type = 'action_set' AND ag.source_id = s.id
    WHERE ag.group_id IN (SELECT CAST(value AS TEXT) FROM json_each(?6))
    UNION
    SELECT sm.action_id
    FROM definition_members dm
    JOIN definitions d ON d.id = dm.definition_id AND d.is_deleted = FALSE
...
SELECT a.id, a.name, a.description, a.action_type, a.desired_state, a.params, a.params_canonical, a.timeout_seconds, a.schedule, a.is_system, a.created_at, a.created_by, a.updated_at, a.is_deleted
FROM actions a
WHERE a.is_deleted = FALSE
  AND a.is_system = FALSE
  AND a.id > ?1
  AND (?2 = 0 OR a.action_type = ?2)
  AND (
      NOT ?3
      OR NOT EXISTS (
          SELECT 1 FROM assignments x
...
func (q *Queries) ListAuthoringActions(ctx context.Context, arg ListAuthoringActionsParams) ([]Action, error) {
	rows, err := q.db.QueryContext(ctx, listAuthoringActions,
		arg.AfterID,
		arg.TypeFilter,
		arg.UnassignedOnly,
		arg.ScopeRestricted,
...
func (q *Queries) ListAuthoringAssignmentsForSource(ctx context.Context, arg ListAuthoringAssignmentsForSourceParams) ([]ListAuthoringAssignmentsForSourceRow, error) {
	rows, err := q.db.QueryContext(ctx, listAuthoringAssignmentsForSource, arg.SourceType, arg.SourceID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) ListAuthoringDefinitions(ctx context.Context, arg ListAuthoringDefinitionsParams) ([]ListAuthoringDefinitionsRow, error) {
	rows, err := q.db.QueryContext(ctx, listAuthoringDefinitions,
		arg.AfterID,
		arg.ScopeRestricted,
		arg.ScopeGroupIdsJson,
		arg.RowLimit,
...
func (q *Queries) ListContainingActionSetIDs(ctx context.Context, actionID string) ([]string, error) {
	rows, err := q.db.QueryContext(ctx, listContainingActionSetIDs, actionID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) ListContainingDefinitionIDs(ctx context.Context, actionSetID string) ([]string, error) {
	rows, err := q.db.QueryContext(ctx, listContainingDefinitionIDs, actionSetID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) ListDefinitionMembers(ctx context.Context, definitionID string) ([]ListDefinitionMembersRow, error) {
	rows, err := q.db.QueryContext(ctx, listDefinitionMembers, definitionID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) ListManifestActionSetActions(ctx context.Context, setID string) ([]Action, error) {
	rows, err := q.db.QueryContext(ctx, listManifestActionSetActions, setID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) ListManifestDefinitionActionSets(ctx context.Context, definitionID string) ([]ActionSet, error) {
	rows, err := q.db.QueryContext(ctx, listManifestDefinitionActionSets, definitionID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
SELECT m.action_set_id, a.id, a.name, a.description, a.action_type, a.desired_state, a.params, a.params_canonical, a.timeout_seconds, a.schedule, a.is_system, a.created_at, a.created_by, a.updated_at, a.is_deleted
FROM definition_members m
JOIN action_sets s ON s.id = m.action_set_id AND s.is_deleted = FALSE
JOIN action_set_members sm ON sm.set_id = s.id
...
func (q *Queries) ListManifestDefinitionActions(ctx context.Context, definitionID string) ([]ListManifestDefinitionActionsRow, error) {
	rows, err := q.db.QueryContext(ctx, listManifestDefinitionActions, definitionID)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) RemoveAuthoringActionSetMember(ctx context.Context, arg RemoveAuthoringActionSetMemberParams) (ActionSetMember, error) {
	row := q.db.QueryRowContext(ctx, removeAuthoringActionSetMember, arg.SetID, arg.ActionID)
	var i ActionSetMember
	err := row.Scan(
		&i.SetID,
		&i.ActionID,
...
func (q *Queries) RemoveAuthoringDefinitionMember(ctx context.Context, arg RemoveAuthoringDefinitionMemberParams) (DefinitionMember, error) {
	row := q.db.QueryRowContext(ctx, removeAuthoringDefinitionMember, arg.DefinitionID, arg.ActionSetID)
	var i DefinitionMember
	err := row.Scan(
		&i.DefinitionID,
		&i.ActionSetID,
...
func (q *Queries) RenameAuthoringActionSet(ctx context.Context, arg RenameAuthoringActionSetParams) (ActionSet, error) {
	row := q.db.QueryRowContext(ctx, renameAuthoringActionSet, arg.Name, arg.UpdatedAt, arg.ID)
	var i ActionSet
	err := row.Scan(
		&i.ID,
		&i.Name,
...
func (q *Queries) RenameAuthoringDefinition(ctx context.Context, arg RenameAuthoringDefinitionParams) (Definition, error) {
	row := q.db.QueryRowContext(ctx, renameAuthoringDefinition, arg.Name, arg.UpdatedAt, arg.ID)
	var i Definition
	err := row.Scan(
		&i.ID,
		&i.Name,
...
func (q *Queries) ReorderAuthoringActionSetMember(ctx context.Context, arg ReorderAuthoringActionSetMemberParams) (ActionSetMember, error) {
	row := q.db.QueryRowContext(ctx, reorderAuthoringActionSetMember, arg.SortOrder, arg.SetID, arg.ActionID)
	var i ActionSetMember
	err := row.Scan(
		&i.SetID,
		&i.ActionID,
...
func (q *Queries) ReorderAuthoringDefinitionMember(ctx context.Context, arg ReorderAuthoringDefinitionMemberParams) (DefinitionMember, error) {
	row := q.db.QueryRowContext(ctx, reorderAuthoringDefinitionMember, arg.SortOrder, arg.DefinitionID, arg.ActionSetID)
	var i DefinitionMember
	err := row.Scan(
		&i.DefinitionID,
		&i.ActionSetID,
...
func (q *Queries) SoftDeleteAuthoringAction(ctx context.Context, arg SoftDeleteAuthoringActionParams) (Action, error) {
	row := q.db.QueryRowContext(ctx, softDeleteAuthoringAction, arg.UpdatedAt, arg.ID, arg.AllowSystem)
	var i Action
	err := row.Scan(
		&i.ID,
		&i.Name,
...
func (q *Queries) SoftDeleteAuthoringActionSet(ctx context.Context, arg SoftDeleteAuthoringActionSetParams) (ActionSet, error) {
	row := q.db.QueryRowContext(ctx, softDeleteAuthoringActionSet, arg.UpdatedAt, arg.ID)
	var i ActionSet
	err := row.Scan(
		&i.ID,
		&i.Name,
...
func (q *Queries) SoftDeleteAuthoringDefinition(ctx context.Context, arg SoftDeleteAuthoringDefinitionParams) (Definition, error) {
	row := q.db.QueryRowContext(ctx, softDeleteAuthoringDefinition, arg.UpdatedAt, arg.ID)
	var i Definition
	err := row.Scan(
		&i.ID,
		&i.Name,
...
func (q *Queries) UpdateAuthoringActionDescription(ctx context.Context, arg UpdateAuthoringActionDescriptionParams) (Action, error) {
	row := q.db.QueryRowContext(ctx, updateAuthoringActionDescription,
		arg.Description,
		arg.UpdatedAt,
		arg.ID,
		arg.AllowSystem,
...
type UpdateAuthoringActionParamsParams struct {
	...
	Params          sqlitetype.JSON `json:"params"`
	ParamsCanonical []byte          `json:"params_canonical"`
	HasTimeout      int32           `json:"has_timeout"`
	TimeoutSeconds  int32           `json:"timeout_seconds"`
	HasSchedule     interface{}     `json:"has_schedule"`
	Schedule        sqlitetype.JSON `json:"schedule"`
	UpdatedAt       *time.Time      `json:"updated_at"`
	ID              string          `json:"id"`
	AllowSystem     interface{}     `json:"allow_system"`
...
func (q *Queries) UpdateAuthoringActionParams(ctx context.Context, arg UpdateAuthoringActionParamsParams) (Action, error) {
	row := q.db.QueryRowContext(ctx, updateAuthoringActionParams,
		arg.DesiredState,
		arg.Params,
		arg.ParamsCanonical,
		arg.HasTimeout,
...
func (q *Queries) UpdateAuthoringActionSetDescription(ctx context.Context, arg UpdateAuthoringActionSetDescriptionParams) (ActionSet, error) {
	row := q.db.QueryRowContext(ctx, updateAuthoringActionSetDescription, arg.Description, arg.UpdatedAt, arg.ID)
	var i ActionSet
	err := row.Scan(
		&i.ID,
		&i.Name,
...
func (q *Queries) UpdateAuthoringActionSetPolicy(ctx context.Context, arg UpdateAuthoringActionSetPolicyParams) (ActionSet, error) {
	row := q.db.QueryRowContext(ctx, updateAuthoringActionSetPolicy,
		arg.Schedule,
		arg.OnFailure,
		arg.UpdatedAt,
		arg.ID,
...
func (q *Queries) UpdateAuthoringDefinitionDescription(ctx context.Context, arg UpdateAuthoringDefinitionDescriptionParams) (Definition, error) {
	row := q.db.QueryRowContext(ctx, updateAuthoringDefinitionDescription, arg.Description, arg.UpdatedAt, arg.ID)
	var i Definition
	err := row.Scan(
		&i.ID,
		&i.Name,
...
func (q *Queries) UpdateAuthoringDefinitionSchedule(ctx context.Context, arg UpdateAuthoringDefinitionScheduleParams) (Definition, error) {
	row := q.db.QueryRowContext(ctx, updateAuthoringDefinitionSchedule, arg.Schedule, arg.UpdatedAt, arg.ID)
	var i Definition
	err := row.Scan(
		&i.ID,
		&i.Name,
