<script lang="ts" module>
	import { cn as cnClass } from "$lib/utils.js";
	...
	export type Side = keyof typeof sheetSideClasses;

	export function sheetVariants(options: { side?: Side } = {}) {
		return cnClass(sheetBase, sheetSideClasses[options.side ?? "right"]);
	}
</script>
