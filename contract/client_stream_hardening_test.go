...
func TestDispatchRejectsInvalidServerEnvelope(t *testing.T) {
	for name, msg := range map[string]*cadestrov1.ServerMessage{
		"nil":                 nil,
		"bad id":              {Id: &cadestrov1.MessageId{Value: "not-a-ulid"}, Payload: &cadestrov1.ServerMessage_Welcome{Welcome: &cadestrov1.Welcome{}}},
		"nil payload":         {Id: &cadestrov1.MessageId{Value: NewULID()}},
		"nil payload message": {Id: &cadestrov1.MessageId{Value: NewULID()}, Payload: &cadestrov1.ServerMessage_Welcome{}},
	} {
