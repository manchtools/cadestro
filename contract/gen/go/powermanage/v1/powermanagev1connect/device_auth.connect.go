...
const (
	...
	DeviceAuthServiceName = "powermanage.v1.DeviceAuthService"
)
...
const (
	...
	// RPC.
	DeviceAuthServiceEnrollProcedure = "/powermanage.v1.DeviceAuthService/Enroll"
	...
	DeviceAuthServiceGetEnrollmentStatusProcedure = "/powermanage.v1.DeviceAuthService/GetEnrollmentStatus"
)

// DeviceAuthServiceClient is a client for the powermanage.v1.DeviceAuthService service.
...
// NewDeviceAuthServiceClient constructs a client for the powermanage.v1.DeviceAuthService service.
...
func NewDeviceAuthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) DeviceAuthServiceClient {
	...
	deviceAuthServiceMethods := v1.File_powermanage_v1_device_auth_proto.Services().ByName("DeviceAuthService").Methods()
...
// Enroll calls powermanage.v1.DeviceAuthService.Enroll.
...
// GetEnrollmentStatus calls powermanage.v1.DeviceAuthService.GetEnrollmentStatus.
...
// DeviceAuthServiceHandler is an implementation of the powermanage.v1.DeviceAuthService service.
...
func NewDeviceAuthServiceHandler(svc DeviceAuthServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/powermanage.v1.DeviceAuthService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedDeviceAuthServiceHandler) Enroll(context.Context, *connect.Request[v1.EnrollRequest]) (*connect.Response[v1.EnrollResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("powermanage.v1.DeviceAuthService.Enroll is not implemented"))
}
...
func (UnimplementedDeviceAuthServiceHandler) GetEnrollmentStatus(context.Context, *connect.Request[v1.GetEnrollmentStatusRequest]) (*connect.Response[v1.GetEnrollmentStatusResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("powermanage.v1.DeviceAuthService.GetEnrollmentStatus is not implemented"))
}
