...
const (
	...
	DeviceAuthServiceName = "cadestro.v1.DeviceAuthService"
)
...
const (
	...
	// RPC.
	DeviceAuthServiceEnrollProcedure = "/cadestro.v1.DeviceAuthService/Enroll"
	...
	DeviceAuthServiceGetEnrollmentStatusProcedure = "/cadestro.v1.DeviceAuthService/GetEnrollmentStatus"
)
...
// NewDeviceAuthServiceClient constructs a client for the cadestro.v1.DeviceAuthService service. By
...
func NewDeviceAuthServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) DeviceAuthServiceClient {
	...
	deviceAuthServiceMethods := v1.File_cadestro_v1_device_auth_proto.Services().ByName("DeviceAuthService").Methods()
...
// Enroll calls cadestro.v1.DeviceAuthService.Enroll.
...
// GetEnrollmentStatus calls cadestro.v1.DeviceAuthService.GetEnrollmentStatus.
...
func NewDeviceAuthServiceHandler(svc DeviceAuthServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/cadestro.v1.DeviceAuthService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedDeviceAuthServiceHandler) Enroll(context.Context, *connect.Request[v1.EnrollRequest]) (*connect.Response[v1.EnrollResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("cadestro.v1.DeviceAuthService.Enroll is not implemented"))
}
...
func (UnimplementedDeviceAuthServiceHandler) GetEnrollmentStatus(context.Context, *connect.Request[v1.GetEnrollmentStatusRequest]) (*connect.Response[v1.GetEnrollmentStatusResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("cadestro.v1.DeviceAuthService.GetEnrollmentStatus is not implemented"))
}
