...
const (
	...
	AgentServiceName = "cadestro.v1.AgentService"
)
...
const (
	...
	AgentServiceStreamProcedure = "/cadestro.v1.AgentService/Stream"
)
...
// NewAgentServiceClient constructs a client for the cadestro.v1.AgentService service. By default,
...
func NewAgentServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) AgentServiceClient {
	...
	agentServiceMethods := v1.File_cadestro_v1_agent_proto.Services().ByName("AgentService").Methods()
...
// Stream calls cadestro.v1.AgentService.Stream.
...
func NewAgentServiceHandler(svc AgentServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/cadestro.v1.AgentService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedAgentServiceHandler) Stream(context.Context, *connect.BidiStream[v1.AgentMessage, v1.ServerMessage]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("cadestro.v1.AgentService.Stream is not implemented"))
}
