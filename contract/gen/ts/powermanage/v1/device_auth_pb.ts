...
// @generated from file powermanage/v1/device_auth.proto (package powermanage.v1, syntax proto3)
/* eslint-disable */
...
/**
 * Describes the file powermanage/v1/device_auth.proto.
 */
export const file_powermanage_v1_device_auth: GenFile = /*@__PURE__*/
  fileDesc("");

/**
 * @generated from message powermanage.v1.EnrollRequest
 */
export type EnrollRequest = Message<"powermanage.v1.EnrollRequest"> & {
  /**
...
/**
 * Describes the message powermanage.v1.EnrollRequest.
 * Use `create(EnrollRequestSchema)` to create a new message.
 */
export const EnrollRequestSchema: GenMessage<EnrollRequest> = /*@__PURE__*/
  messageDesc(file_powermanage_v1_device_auth, 0);

/**
 * @generated from message powermanage.v1.EnrollResponse
 */
export type EnrollResponse = Message<"powermanage.v1.EnrollResponse"> & {
  /**
...
/**
 * Describes the message powermanage.v1.EnrollResponse.
...
export const EnrollResponseSchema: GenMessage<EnrollResponse> = /*@__PURE__*/
  messageDesc(file_powermanage_v1_device_auth, 1);

/**
 * @generated from message powermanage.v1.GetEnrollmentStatusRequest
 */
export type GetEnrollmentStatusRequest = Message<"powermanage.v1.GetEnrollmentStatusRequest"> & {
};

/**
 * Describes the message powermanage.v1.GetEnrollmentStatusRequest.
...
export const GetEnrollmentStatusRequestSchema: GenMessage<GetEnrollmentStatusRequest> = /*@__PURE__*/
  messageDesc(file_powermanage_v1_device_auth, 2);

/**
 * @generated from message powermanage.v1.GetEnrollmentStatusResponse
 */
export type GetEnrollmentStatusResponse = Message<"powermanage.v1.GetEnrollmentStatusResponse"> & {
  /**
   * @gotags: validate:"required"
   *
...
/**
 * Describes the message powermanage.v1.GetEnrollmentStatusResponse.
...
export const GetEnrollmentStatusResponseSchema: GenMessage<GetEnrollmentStatusResponse> = /*@__PURE__*/
  messageDesc(file_powermanage_v1_device_auth, 3);

/**
 * @generated from service powermanage.v1.DeviceAuthService
 */
export const DeviceAuthService: GenService<{
  /**
   * Enroll the agent with a PM server (called by CLI, no sudo required).
   *
   * @generated from rpc powermanage.v1.DeviceAuthService.Enroll
   */
  enroll: {
    methodKind: "unary";
   ...
   *
   * @generated from rpc powermanage.v1.DeviceAuthService.GetEnrollmentStatus
   */
  getEnrollmentStatus: {
    methodKind: "unary";
  ...
  serviceDesc(file_powermanage_v1_device_auth, 0);
